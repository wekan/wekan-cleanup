...
def main() :
	...
	for board in boards.find() :
		if cards.count({"boardId": board['_id']}) == 0  and board['modifiedAt'] < time_clean_board_nocard :
			print "[BOARD] Deleting board " + str(board['_id']) + " (0 card into and modified more than " + str(day_to_keep_board_nocard) + " day(s) ago)...."
